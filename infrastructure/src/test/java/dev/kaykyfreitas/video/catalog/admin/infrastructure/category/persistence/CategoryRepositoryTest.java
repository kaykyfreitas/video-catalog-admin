...
public class CategoryRepositoryTest {
    ...
    public void givenAnInvalidNullName_whenCallsSave_shouldReturnError() {
        ...
        final var expectedMessage = "not-null property references a null or transient value : dev.kaykyfreitas.video.catalog.admin.infrastructure.category.persistence.CategoryJpaEntity.name";
    ...
    public void givenAnInvalidNullCreatedAt_whenCallsSave_shouldReturnError() {
        ...
        final var expectedMessage = "not-null property references a null or transient value : dev.kaykyfreitas.video.catalog.admin.infrastructure.category.persistence.CategoryJpaEntity.createdAt";
        final var aCategory = Category.newCategory("Filmes", "A categoria mais assistida", true);
    ...
    public void givenAnInvalidNullUpdatedAt_whenCallsSave_shouldReturnError() {
        ...
        final var expectedMessage = "not-null property references a null or transient value : dev.kaykyfreitas.video.catalog.admin.infrastructure.category.persistence.CategoryJpaEntity.updatedAt";
        final var aCategory = Category.newCategory("Filmes", "A categoria mais assistida", true);
