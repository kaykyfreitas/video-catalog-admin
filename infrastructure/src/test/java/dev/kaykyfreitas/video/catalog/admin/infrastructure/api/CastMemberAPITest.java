...
import dev.kaykyfreitas.video.catalog.admin.application.castmember.create.CreateCastMemberOutput;
...
import dev.kaykyfreitas.video.catalog.admin.application.castmember.update.UpdateCastMemberOutput;
...
public class CastMemberAPITest {
    ...
    public void givenAValidCommand_whenCallsCreateCastMember_shouldReturnItsIdentifier() throws Exception {
        ...
        final var expectedId = CastMemberId.from("123456789");
